...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, email: $email, name: $name, profileImage: $profileImage, isVerified: $isVerified, additionalData: $additionalData)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, email, name, profileImage,
      isVerified, const DeepCollectionEquality().hash(_additionalData));
...
abstract class _User implements User {
  const factory _User(
      ...
      final String? profileImage,
      final bool isVerified,
      final Map<String, dynamic> additionalData}) = _$UserImpl;
